...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-top (:color blue)
    ...
    ("n" hydra-charnav/body)
    ("s" hydra-splitter/body)
    ("q" nil)
    ("<escape>" nil))
  (global-set-key (kbd "<escape>")     'hydra-top/body)
...
#+BEGIN_SRC emacs-lisp
  (use-package windmove
    ...
    :config
    (progn        
      (defhydra hydra-windmove (:color pink)
        "windmove"
        ("h" windmove-left)
        ("j" windmove-down)
        ("k" windmove-up)
        ...
        ("<escape>" hydra-top/body nil :color blue)
        ("n" hydra-charnav/body nil :color blue)
        ("s" hydra-splitter/body nil :color blue))
      (global-set-key (kbd "C-z w")     'hydra-windmove/body)))
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-splitter (global-map "C-z s")
    ...
    ("q" nil nil :color blue)
    ("<escape>" hydra-top/body nil :color blue)
    ("w" hydra-windmove/body nil :color blue)
    ("n" hydra-charnav/body nil :color blue))
...
#+BEGIN_SRC emacs-lisp
  (defhydra hydra-charnav (:color pink)
    "navigation"
    ("h" left-char)
    ("j" next-line)
    ("k" previous-line)
    ...
    ("w" hydra-windmove/body nil :color blue)
    ("s" hydra-splitter/body nil :color blue))
  (global-set-key (kbd "C-n")   'hydra-charnav/body)
