...
#+BEGIN_SRC emacs-lisp
  ...
  (global-set-key (kbd "C-x C-F") 'sudo-find-file)
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package helm-package
    ...
    :config
    (progn
      (global-set-key (kbd "C-z p") 'helm-package)))
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package helm-mode-manager
    ...
    :config
    (progn
      (global-set-key (kbd "C-z n") 'helm-enable-minor-mode)
      (global-set-key (kbd "C-z m") 'helm-switch-major-mode)))
#+END_SRC
